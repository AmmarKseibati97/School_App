...
import 'package:a_school_app/features/students/domain/use_cases/check_students_usecase.dart'
    as _i19;
import 'package:a_school_app/features/students/domain/use_cases/fetch_checks_usecase.dart'
    as _i18;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i18.FetchChecksUseCase>(
        () => _i18.FetchChecksUseCase(gh<_i16.StudentDomainRepository>()));
    gh.lazySingleton<_i19.CheckStudentsUseCase>(
        () => _i19.CheckStudentsUseCase(gh<_i16.StudentDomainRepository>()));
    gh.lazySingleton<_i20.FetchStudentsUseCase>(
        () => _i20.FetchStudentsUseCase(gh<_i16.StudentDomainRepository>()));
    gh.lazySingleton<_i21.GetAbsencesUseCase>(
        () => _i21.GetAbsencesUseCase(gh<_i16.StudentDomainRepository>()));
    gh.lazySingleton<_i22.LangRepository>(() => _i23.LangRepositoryImpl(
        langLocalDataSource: gh<_i15.LangLocalDataSource>()));
    gh.lazySingleton<_i24.PrefManagerImpl>(
        () => _i24.PrefManagerImpl(gh<_i3.SharedPreferences>()));
    gh.singleton<_i25.StudentBloc>(() => _i25.StudentBloc(
          fetchStudentsUseCase: gh<_i20.FetchStudentsUseCase>(),
          checkStudentsUseCase: gh<_i19.CheckStudentsUseCase>(),
          getAbsencesUseCase: gh<_i21.GetAbsencesUseCase>(),
        ));
    gh.lazySingleton<_i26.ChangeLangUseCase>(() =>
        _i26.ChangeLangUseCase(langRepository: gh<_i22.LangRepository>()));
    gh.lazySingleton<_i27.GetSavedLangUseCase>(() =>
        _i27.GetSavedLangUseCase(langRepository: gh<_i22.LangRepository>()));
    gh.singleton<_i28.AuthDomainRepository>(
        () => _i29.AuthRepositoryImpl(gh<_i12.AuthRemoteDataSource>()));
    gh.lazySingleton<_i30.LocaleCubit>(() => _i30.LocaleCubit(
          getSavedLangUseCase: gh<_i27.GetSavedLangUseCase>(),
          changeLangUseCase: gh<_i26.ChangeLangUseCase>(),
        ));
    gh.lazySingleton<_i31.LoadUserUseCase>(
        () => _i31.LoadUserUseCase(gh<_i28.AuthDomainRepository>()));
    gh.lazySingleton<_i32.LoginUseCase>(
        () => _i32.LoginUseCase(gh<_i28.AuthDomainRepository>()));
    gh.lazySingleton<_i33.SignOutUseCase>(
        () => _i33.SignOutUseCase(gh<_i28.AuthDomainRepository>()));
    gh.factory<_i34.AuthBloc>(() => _i34.AuthBloc(
          loginUseCase: gh<_i32.LoginUseCase>(),
          loadUserUseCase: gh<_i31.LoadUserUseCase>(),
...
class _$RegisterPrefManagerModule extends _i35.RegisterPrefManagerModule {}
